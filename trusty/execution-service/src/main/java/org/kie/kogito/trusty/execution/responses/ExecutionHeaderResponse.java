...
public class ExecutionHeaderResponse {
    ...
    public ExecutionHeaderResponse(String executionId, Date executionDate, boolean executionSucceeded, String executorName, String executedModelName, ExecutionTypeEnumResponse executionType) {
