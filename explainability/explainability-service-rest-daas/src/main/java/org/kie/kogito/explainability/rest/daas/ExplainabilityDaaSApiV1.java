...
import org.kie.kogito.explainability.rest.daas.models.ExplainabilityDaaSRequestDto;

@Path("/v1")
public class ExplainabilityDaaSApiV1 {

    protected ExplanationService explanationService;
    protected PredictionProviderFactory predictionProviderFactory;

    @Inject
    public ExplainabilityDaaSApiV1(
    ...
    public Uni<Response> explain(ExplainabilityDaaSRequestDto requestDto) {
