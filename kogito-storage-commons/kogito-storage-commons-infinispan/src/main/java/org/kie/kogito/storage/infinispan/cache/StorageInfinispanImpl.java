...
public class StorageInfinispanImpl<K, V> implements Storage<K, V> {

    private static final Logger LOGGER = LoggerFactory.getLogger(StorageInfinispanImpl.class);

    private RemoteCache<K, V> delegate;
    private String rootType;

    public StorageInfinispanImpl(RemoteCache<K, V> delegate, String rootType) {
